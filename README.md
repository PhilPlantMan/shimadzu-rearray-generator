...
4. Run `pyinstaller shimadzu-rearray-generator.py --add-data "shimadzu_adapter_coordinates_Precision_adapter.csv;." --add-data "MALDITOF-PINNING-PROFILE.xml;." --add-data "shimadzu_adapter_coordinates_SI_adapter.csv;." --add-data "thermo_nunc_96_coordinates.csv;." --version-file file_version_info.txt`
`
