...
The app allows users to select a Colony Detection folder
...
### Reporting issues
Please submit problems and feature requests via the Issues tab on GitHub.
...
See docs/mermaid.js/flowchart.txt
...
4. Run `pyinstaller Shimadzu-rearray-generator.py --add-data "shimadzu_adapter_coordinates_Precision_adapter.csv;." --add-data "MALDITOF-PINNING-PROFILE.xml;." --add-data "shimadzu_adapter_coordinates_SI_adapter.csv;." --add-data "icon.ico;." --version-file file_version_info.txt --icon icon.ico
`
